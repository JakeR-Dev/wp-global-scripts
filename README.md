...
![Global Scripts icon](assets/icon-256x256.png)
...
The plugin includes icon assets in the `assets/` directory for GitHub and WordPress.org presentation:

- `assets/icon-20x20.png`
- `assets/icon-128x128.png`
- `assets/icon-256x256.png`

WordPress.org will automatically use the standard icon files when they are present in `assets/` with these names.
